 ...
 */
 ...
 export default class Markdown extends Component {
   ...
   static propTypes = {
     ...
     style: PropTypes.any,
     defaultTextProps: PropTypes.any,
   };
   ...
   shouldComponentUpdate(nextProps, nextState) {
     ...
     if (
       ...
       nextProps.defaultTextProps !== this.props.defaultTextProps
     ) {
       return true;
     }
   ...
   updateSettings(props = this.props) {
     const { renderer, rules, style, plugins, markdownit, defaultTextProps } = props;
     ...
     if (renderer) {
       ...
       if (!this.renderer || this.props.renderer || this.props.rules !== rules || this.props.style !== style || this.props.defaultTextProps !== defaultTextProps) {
